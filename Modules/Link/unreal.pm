# $Id: unreal.pm 9880 2008-06-09 15:33:09Z Thunderhacker $
...
sub link_init
{
        ...
        main::provides("server","unreal-server","native-gline","native-globops");
	if (($numeric < 1) || ($numeric > 255)) {
		...
		print "(take a look at the values in /MAP)\n\n";
		exit(0);
	}
}
...
sub connect {
	...
	&rawirc("SERVER $servername 1 :U0-*-$numeric $serverdesc");
